...
class PortScanner:
    ...
    def __init__(self, ports: List[int]):
        self.ports = ports
        # Reuse thread pool to avoid overhead of creating one per host
        # 200 workers is a safe balance for typical usage (20 hosts * 10 threads)
    ...
    def _scan_host_parallel(self, ip: str) -> List[int]:
        """Parallel port scanning reusing shared ThreadPoolExecutor."""
        open_ports = []

        # Submit all port checks to the shared executor
        future_to_port = {
